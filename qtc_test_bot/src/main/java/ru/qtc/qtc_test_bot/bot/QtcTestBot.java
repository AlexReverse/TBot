package ru.qtc.qtc_test_bot.bot;
...
import ru.qtc.qtc_test_bot.service.ExchangeRatesService;

import java.time.LocalDate;

@Component
public class QtcTestBot extends TelegramLongPollingBot {

    private static final Logger LOG = LoggerFactory.getLogger(QtcTestBot.class);
    ...
    public QtcTestBot(@Value("${bot.token}") String botToken){
        super(botToken);
    }
    @Override
    ...
    private void helpCommand(Long chatId) {
        var text = """
                ...
                Для получения текущего курса валют используйте команды:
                /usd - курс доллара
                /eur - курс евро
                """;
